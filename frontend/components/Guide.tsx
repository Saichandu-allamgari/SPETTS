...
export default function GuidePage() {
  ...
  useEffect(() => {
    ...
    if (
      tab &&
      ["overview", "cpr", "ivfluid", "airway", "spinal"].includes(
        tab
      )
    ) {
      setActive(tab as GuideKey);
    }
  }, [searchParams]);
  ...
  const guides = {
    overview: {
      title: "Emergency Guide Center",
      images: ["/guide/overview.jpg"],
      desc: `This section provides quick emergency response guides for first responders.`,
      points: [
        "✔ CPR Emergency Response",
        "✔ IV Fluid Resuscitation",
        "✔ Airway Alert Management",
    ...
    cpr: {
      ...
      desc: `CPR is performed when a person is unconscious and not breathing.`,
      points: [
        "1. Check response",
        "2. Call emergency support",
        "3. Start chest compressions",
    ...
    ivfluid: {
      title: "IV Fluid Resuscitation",
      images: ["/IV-Fluid.jpeg"],
      desc: `Used for shock, dehydration, blood loss.`,
      points: [
        "1. Prepare IV equipment",
        "2. Insert IV line",
        "3. Start fluids",
    ...
    airway: {
      title: "Airway Alert",
      images: ["/Airway-alert.jpeg"],
      desc: `Maintain airway immediately if breathing compromised.`,
      points: [
        "1. Check airway blockage",
        "2. Head tilt / jaw thrust",
        "3. Insert airway adjunct",
    ...
    spinal: {
      title: "Spinal Immobilization",
      images: ["/spinal.jpeg"],
      desc: `Used in trauma or suspected spinal injury.`,
      points: [
        "1. Stabilize neck",
        "2. Apply collar",
        "3. Use spine board",
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-5 gap-3 mb-10">
          {[
            ...
            ["cpr", "CPR", "bg-red-600"],
            ["ivfluid", "IV Fluid", "bg-green-600"],
            ["airway", "Airway", "bg-orange-600"],
            ["spinal", "Spinal", "bg-purple-600"],
          ].map(([key, label, color]) => (
            <button
              key={key}
              onClick={() =>
                setActive(key as GuideKey)
              }
